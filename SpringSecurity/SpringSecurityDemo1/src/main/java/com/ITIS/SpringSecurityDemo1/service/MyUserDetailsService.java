package com.ITIS.SpringSecurityDemo1.service;

import com.ITIS.SpringSecurityDemo1.entity.Users;
import com.ITIS.SpringSecurityDemo1.mapper.UsersMapper;
...
//    }
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        //给查询出的用户设置权限
        List<GrantedAuthority> auths = AuthorityUtils.commaSeparatedStringToAuthorityList("admin,ROLE_sale,ROLE_admin");
        //从查询数据库返回users对象，得到用户名和密码并设置权限后返回
